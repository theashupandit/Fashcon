          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <span className="text-[9px] font-black uppercase tracking-[0.2em] text-zinc-500">System Configuration Hub</span>
            ...
            >
              <span className={cn(
                ...
                isCollapsed ? "text-zinc-400 group-hover:text-white" : "text-white"
              )}>
