...
const Toaster = ({ ...props }: ToasterProps) => {
  ...
  return (
    <Sonner
      ...
      toastOptions={{
        classNames: {
          toast: "group toast group-[.toaster]:bg-[var(--card)] group-[.toaster]:text-[var(--foreground)] group-[.toaster]:border-[var(--border)] group-[.toaster]:shadow-sm group-[.toaster]:rounded-2xl group-[.toaster]:px-3.5 group-[.toaster]:py-2.5 group-[.toaster]:font-bold group-[.toaster]:text-[12px] group-[.toaster]:tracking-tight group-[.toaster]:min-w-[280px] sm:group-[.toaster]:min-w-[320px]",
