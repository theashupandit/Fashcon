        ...
        actions={
          <div className="flex items-center gap-3">
            ...
            <Button 
              ...
              disabled={saving}
              className="h-10 px-6 rounded-full bg-[var(--foreground)] text-[var(--background)] hover:opacity-90 font-black uppercase tracking-widest text-[10px] gap-2 shadow-lg transition-all active:scale-95"
            >
