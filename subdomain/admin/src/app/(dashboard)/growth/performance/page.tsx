    ...
    <div className={cn(
      ...
      <div className="mb-10 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          )}>Real-time PageSpeed Insights analysis.</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        <motion.div 
          ...
          className={cn(
            "lg:col-span-1 border rounded-2xl p-8 flex flex-col items-center justify-center relative overflow-hidden",
        ...
        >
          ...
          <h3 className={cn("text-lg font-bold mb-6", isDark ? "text-white" : "text-black")}>Performance Score</h3>
          <div className="relative w-48 h-48 flex items-center justify-center">
            ...
            <div className="text-center">
              <span className={cn("text-6xl font-black", isDark ? "text-white" : "text-black")}>92</span>
            </div>
          </div>
        </motion.div>
          ...
          {[
            ...
            >
              ...
              <div className="mt-4 flex items-end justify-between">
                <span className={cn("text-2xl font-bold", isDark ? "text-white" : "text-black")}>{metric.value}</span>
      ...
      <div className={cn(
        ...
        <h3 className="text-lg font-semibold mb-6 flex items-center gap-2">
          <Activity className={cn("w-5 h-5", isDark ? "text-white" : "text-black")} /> Optimization Opportunities
        </h3>
        <div className="space-y-2">
          {[
            ...
            <div key={i} className={cn(
              ...
              isDark ? "bg-white/[0.02] hover:bg-white/[0.04] border-white/5" : "bg-black/[0.02] hover:bg-black/[0.04] border-black/5"
            )}>
              <div className="flex items-center gap-4">
                <div className={cn(
                  "p-2 rounded-lg",
                ...
                <span className={cn("text-sm font-medium", isDark ? "text-white" : "text-black")}>{opp.msg}</span>
              </div>
              <div className="flex items-center gap-4">
