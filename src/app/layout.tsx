    ...
    return (
      <html lang="en" suppressHydrationWarning className={cn("font-sans", geist.variable, playfair.variable)}>
        <body className={cn(inter.className, "overflow-x-hidden w-full bg-neutral-950 text-white")} suppressHydrationWarning>
          ...
          <noscript>
            <iframe
              src="https://www.googletagmanager.com/ns.html?id=GTM-54DLGX75"
              height="0"
              width="0"
          ...
          {/* Google Tag Manager */}
          <Script id="gtm-maintenance" strategy="beforeInteractive">
            {`
              (function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
              new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
              j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
              'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
              })(window,document,'script','dataLayer','GTM-54DLGX75');
            `}
          </Script>
          ...
          />
          <Script id="google-analytics-maintenance" strategy="beforeInteractive">
            {`
