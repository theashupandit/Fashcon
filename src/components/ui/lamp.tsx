...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-[40rem] flex-col items-center justify-center bg-[var(--background)] w-full rounded-md z-0",
        className
      )}
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        <motion.div
          ...
          className="absolute inset-auto right-1/2 h-56 overflow-visible w-[30rem] bg-gradient-conic from-cyan-500 via-transparent to-transparent text-white [--conic-gradient-from:transparent] [--tw-gradient-stops:var(--cyan-500)_0%,_transparent_100%]"
        >
        ...
        <motion.div
          ...
          className="absolute inset-auto left-1/2 h-56 w-[30rem] bg-gradient-conic from-transparent via-transparent to-cyan-500 text-white [--conic-gradient-from:transparent] [--tw-gradient-stops:transparent_0%,_var(--cyan-500)_100%]"
        >
